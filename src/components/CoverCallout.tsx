...
export const CoverCallout = () => {
    return (
        <div className="bg-pink-200 w-full aspect-[4/2] grid grid-cols-3">
            <div className="flex flex-col justify-center align-middle text-center gap-6 w-3/4 ms-auto me-auto">
                ...
                <div className="text-akredarkgray grid grid-cols-3 text-left">
                    ...
                    <div>Email:</div><div className="col-span-2">akremustikad@gmail.com</div>
                </div>
                <div className="mx-auto"><div className="border-2 border-black rounded-full py-3 px-12">Kirjuta meile</div></div>
            </div>
