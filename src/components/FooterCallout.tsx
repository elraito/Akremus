...
export const FooterCallout = () => {
  return (
    <div className="aspect-[4/1]">
      <div className="w-3/4 md:w-1/2 h-full mx-auto flex flex-col text-center justify-evenly gap-2">
        ...
        <div className="mx-auto">
          <div className="border border-akrebrown rounded-full py-3 px-6 md:px-12 text-akrebrown hover:bg-akrebrown hover:text-white">
            Kirjuta meile
          </div>
        </div>
      </div>
